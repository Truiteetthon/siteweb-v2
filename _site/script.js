...
const changedata = () => {
  ...
  if (icurrentIndex >= 26 && icurrentIndex <= 30) {
    ...
    DescriptionProjet =
      "Installation sculpturale <br> avec Caroline Fortin autrice<br><br>Prix Innovation<br>Grands Prix Desjardins de la culture de Lanaudière<br><br>Sainte-Mélanie, Québec";
  }
  if (icurrentIndex >= 31 && icurrentIndex <= 34) {
    Photographe = "Bolide Studio";
    TitreProjet = "Chertsey";
    DescriptionProjet =
      "Mirco développement immobilier<br><br>Chertsey, Québec";
  }
  if (icurrentIndex >= 35 && icurrentIndex <= 39) {
    Photographe = "Fred Tougas";
    TitreProjet = "Sherbrooke";
    DescriptionProjet =
      "Aménagement du SOMO lounge<br>avec Barbeaux Desrosiers<br><br>Montréal, Québec";
  }
  ...
  if (icurrentIndex >= 43 && icurrentIndex <= 46) {
    ...
    DescriptionProjet =
      "Installation sculpturale<br>avec Caroline Fortin autrice<br><br>Grand-Métis, Québec";
  }
  ...
  if (icurrentIndex >= 47 && icurrentIndex <= 48) {
    ...
    TitreProjet = "Monk";
    DescriptionProjet =
      "Aménagement d’un studio de musique<br> avec <br><br>Montréal, Québec";
  }
  if (icurrentIndex >= 49 && icurrentIndex <= 54) {
    Photographe = "David Dworkind";
    TitreProjet = "La Conception";
    DescriptionProjet =
      "Gîte touristique sous <i>hinterhouse</i><br>avec David Dworkind architecte<br><br>Prix d’excellence en architecture<br>Ordre des Architectes du Québec<br><br>La Conception, Québec";
  }
};
